...
const decodeSignedTxn = signedTxnBytes => {
  ...
  const unknowLen = signedTxnReader.readUInt8()
  const argAddress = signedTxnReader.readUInt8()
  const receiverAddress = signedTxnReader.readString(16, 'hex')
  const argsLen1 = signedTxnReader.readUInt8()
  const unknowLen1 = signedTxnReader.readUInt8()
  ...
  const senderPubKeyLen1 = signedTxnReader.readUInt8()
  const sender_public_key = signedTxnReader.readString(senderPubKeyLen1, 'hex')
